...
//clickElementByJS: Clicks on a web element using JavaScript.
//getTitleByJS: Retrieves the page title using JavaScript.
//scrollDownByJS: Scrolls down to the bottom of the page using JavaScript.
//scrollAllUpByJS: Scrolls up to the top of the page using JavaScript.
//scrollIntoViewJS: Scrolls the page to bring a specific element into view using JavaScript.
//changeBackgroundColorByJS: Changes the background color of a web element using JavaScript.
//flash: Flashes the background color of a web element for a visual effect.
//generateAlert: Generates an alert with the specified message using JavaScript.
//executeJScommand: Executes a custom JavaScript command on a web element or the page.
//setValueByJS: Sets the value of an input element using JavaScript.
//getValueByJS: Retrieves the value of an input element using JavaScript.
//addBorderWithJS: Adds a border to a web element using JavaScript.
//These methods provide additional flexibility and control when interacting with web elements beyond what is provided by Selenium's built-in methods.
...
public class JSUtils {
    ...
    // https://www.rapidtables.org/tr/web/color/RGB_Color.html  use this web for practise
